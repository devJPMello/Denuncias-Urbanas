    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-background rounded-2xl shadow-2xl z-50 w-[95vw] max-w-md max-h-[90vh] overflow-hidden flex flex-col animate-in zoom-in-95 fade-in border border-border"
        >
